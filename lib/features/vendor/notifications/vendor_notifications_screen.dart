...
/// Notifications Feed (spec §5.19) — order-lifecycle notifications this
/// Vendor received (`onOrderStatusChange`, `QuickyAdmin/functions/index.js`),
    ...
    return Scaffold(
      ...
      body: async.when(
        data: (items) => NotificationWall(
          ...
          emptySubtitle: 'Order updates will show up here.',
