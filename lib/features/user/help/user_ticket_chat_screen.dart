...
/// Resolves the signed-in User as the chat's sender and the ticket's
/// assigned Territory Manager as the thread title, then hands off to the
/// shared [TicketChatScreen].
class UserTicketChatScreen extends ConsumerWidget {
  const UserTicketChatScreen({super.key, required this.ticketId});
